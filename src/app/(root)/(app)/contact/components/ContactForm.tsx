    ...
    <form className="grid grid-cols-1 gap-4" onSubmit={() => {}}>
      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
        <div>
          ...
          <ValidationError prefix="Name" field="name" errors={null} className="pt-1 text-xs leading-none text-red-600" />
        </div>
        <div>
          <div className="backdrop-blur-lg">
            <input
          ...
          <ValidationError prefix="Email" field="email" errors={null} className="pt-1 text-xs leading-none text-red-600" />
        </div>
      </div>
      <div>
        <div className="backdrop-blur-lg">
        ...
        <ValidationError prefix="Subject" field="subject" errors={null} className="pt-1 text-xs leading-none text-red-600" />
      </div>
      <div>
        <div className="backdrop-blur-lg">
          <textarea
        ...
        <ValidationError prefix="Message" field="message" errors={null} className="pt-1 text-xs leading-none text-red-600" />
      </div>
      <div className="mx-auto h-14 w-1/2 backdrop-blur-lg">
        <button disabled={true} className=" mx-auto block h-full w-full bg-white font-bold opacity-75 hover:opacity-100 dark:bg-black">
          SEND MESSAGE
        </button>
      </div>
    </form>
